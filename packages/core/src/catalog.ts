...
export const METRIC_CATALOG: MetricDef[] = [
  ...
  },
  {
    ...
    unitFamily: "money",
    defaultUnit: "crore",
    aliases: ["gross revenue", "gross sales revenue", "gross billing"],
    higherIsBetter: true,
  },
  {
    key: "gmv",
    ...
    unitFamily: "money",
    defaultUnit: "crore",
    aliases: ["gmv", "gross merchandise", "gross merchandise value"],
    higherIsBetter: true,
  },
  {
  ...
  },
  {
    ...
    unitFamily: "count",
    defaultUnit: "count",
    aliases: ["orders", "order count", "transactions"],
    higherIsBetter: true,
  },
  {
    key: "aov",
  ...
  },
  {
    ...
    unitFamily: "months",
    defaultUnit: "months",
    aliases: ["payback", "cac payback", "payback months", "payback period"],
    higherIsBetter: false,
  },
  {
    key: "churn_pct",
    ...
    unitFamily: "percent",
    defaultUnit: "percent",
    aliases: ["churn", "churn %", "churn rate", "logo churn"],
    higherIsBetter: false,
  },
  {
    key: "repeat_rate_pct",
