...
const PHRASES = ["Cite or refuse.", "Confirm before the book.", "Missing stays blank."] as const;

/** Mid-page headline cycles phrases with blur→sharp horizontal slide. Never repeats the H1. */
